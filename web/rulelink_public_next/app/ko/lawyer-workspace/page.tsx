...
export const metadata: Metadata = {
  title: '변호사 전용 작업공간',
  description: `${site.name} 공개 법률정보와 자격 확인이 필요한 사건별 검토 도구의 경계`,
  alternates: {canonical: '/ko/lawyer-workspace'},
  openGraph: {
    title: `${site.name} 변호사 전용 작업공간`,
  ...
  return (
    <main className="methodPage">
      ...
      <section className="methodGrid" aria-label="변호사 전용으로 운영하는 이유">
        ...
        <article><span>03</span><h2>거래구조의 분리</h2><p>{site.operatorName}는 변호사에게 고정형 기술도구를 제공하고, 일반인의 상담료·수임료·성공보수나 사건 소개 대가를 배분받지 않는 구조를 지향합니다.</p></article>
      ...
      <section className="gateBoundary">
        <h2>일반 이용자라면</h2>
        <p>이 작업공간에 사건을 입력하지 마세요. 공개 {site.name}의 일반 정보를 참고한 뒤 개별 판단이 필요하면 변호사 또는 법무법인과 직접 상담계약을 체결해야 합니다.</p>
