...
test('활성 DB에서 확인한 현행 조문 12개의 좌표와 스냅샷을 고정한다', () => {
  const expected = new Map([
    ...
    ['labor_standards_act_ko_0076_03', 'snapshot:f207c432a00d4f67c0cdb0ce1a7eefd'],
    ['labor_standards_act_ko_0109', 'snapshot:b4b9f59bb50637d9f17e66f6481f858'],
    ['labor_standards_act_ko_0116', 'snapshot:49d0c816451ea310d95594469cd0d6fb'],
    ['equal_employment_opportunity_work_family_balance_assistance_act_ko_0002', 'snapshot:bb8e73e9a7fd7c6ccdb1d910575266e'],
    ['equal_employment_opportunity_work_family_balance_assistance_act_ko_0012', 'snapshot:cb0786784ff86afe5fa5c4fca9315f5'],
    ['equal_employment_opportunity_work_family_balance_assistance_act_ko_0014', 'snapshot:4579f3f3f69df935a4d13ac7b16b88a'],
    ...
    ['equal_employment_opportunity_work_family_balance_assistance_act_ko_0037', 'snapshot:cdbc0ffc9fd17dd3f1632d0f1e19eb4'],
  ...
  const serialized = JSON.stringify(topic.sources);
