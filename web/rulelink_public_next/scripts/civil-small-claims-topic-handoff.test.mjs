...
test('현행 민사소송법·소액사건심판법·규칙 20개 좌표와 스냅샷을 고정한다', () => {
  const expected = new Map([
    ['civil_procedure_ko_0002','snapshot:969be7b51c16c23d167b18ff35cb459'],
    ...
    ['civil_procedure_ko_0213','snapshot:788a76ae5522ff0eee2c3ab2825a8e0'],
    ['civil_procedure_ko_0248','snapshot:2d1d8302cd09563aba0e9b66c5edc1ad'],
    ['civil_procedure_ko_0249','snapshot:56cc66bdcfbeb07c8edc013125ecc45ce'],
    ['civil_procedure_ko_0256','snapshot:b81d9209b2834410a310e9af60e171a0'],
    ['civil_procedure_ko_0257','snapshot:7aa30b0312c82a6781170eca965121fd1'],
    ...
    ['small_claims_trial_ko_0011_02','snapshot:5d0d3b5b9d96dab4cf7a7f53ebfda9e'],
  ]);
