...
test('상가건물 임대차 10개 생활질문의 근거·법리·사실분기를 닫는다', () => {
...
test('활성 DB에서 확인한 현행 조문 16개의 공식 좌표와 스냅샷을 고정한다', () => {
  const expected = new Map([
    ...
    ['commercial_lease_ko_0003', 'snapshot:1d9c6a00a2afec23963281fd3a8e60c'],
    ...
    ['commercial_lease_ko_0019_02', 'snapshot:959d1d862d7fa5e33a9dae165cec9b0'],
    ['commercial_lease_ko_0020', 'snapshot:4a04b15c57fdeaea6a3e000e0e5fa9d'],
  ]);
...
test('갱신·연체·권리금·관리비의 핵심 숫자와 효과를 회귀검사로 고정한다', () => {
